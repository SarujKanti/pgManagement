...
import com.skd.pgmanagement.fragments.dashboard.MainDashboardFragment
...
class MainDashboardScreen : BaseActivity<ActivityMainDashboardBinding>(R.layout.activity_main_dashboard) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val groupId = intent.getStringExtra(StringConstants.GROUP_ID)

        val fragment = MainDashboardFragment().apply {
